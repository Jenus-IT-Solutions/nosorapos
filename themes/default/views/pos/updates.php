                        ...
                        <?php
                            ...
                            if (!empty($updates->data->updates)) {
                                ...
                                foreach ($updates->data->updates as $update) {
                                    ...
                                    if ($c == 1 && $update->mversion != 315) {
                                        echo anchor('system_settings/install_update/' . substr($update->filename, 0, -4) . '/' . (!empty($update->mversion) ? $update->mversion : 0) . '/' . $update->version, '<i class="fa fa-download"></i> ' . lang('install'), 'class="btn btn-primary pull-right"') . ' ';
                                    }
