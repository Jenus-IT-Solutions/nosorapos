...
<div class="wrap">
            ...
            <table style="width:100%; float:right; padding:5px; color:#000; background: #FFF;" id="totalTable">
                ...
                <tr>
                    <td colspan="2"
                        ...
                        Total Payable <?= $Settings->display_symbol ? $Settings->symbol : ''; ?>
                    </td>
                    <td colspan="2"
    ...
    <div class="main">
        ...
        <div class="content" id="rightside-content">
            <iframe class="preview_frame" src="<?= site_url('welcome/promotions'); ?>" name="preview-frame" frameborder="0" noresize="noresize"></iframe>
            <div class="clearfix"></div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    var product_tax = 0, invoice_tax = 0, total_discount = 0, product_discount = 0, order_discount = 0, total = 0, tax_rates = <?php echo json_encode($tax_rates); ?>, pos_customer = localStorage.getItem('poscustomer');
