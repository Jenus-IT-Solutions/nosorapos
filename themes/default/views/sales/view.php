                    ...
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                <td style="width: 100px; text-align:center; vertical-align:middle;"><?= $this->sma->formatQuantity($row->quantity).' '.$row->unit; ?></td>
                                <?php
                                if ($Settings->product_serial) {
                    ...
                    <div class="col-xs-6">
                        ...
                        if ($Settings->invoice_view == 1) {
                            if (!empty($tax_summary)) {
                                ...
                                echo '</tbody></tfoot>';
                                echo '<tr><th colspan="4" class="text-right">' . lang('total_tax_amount') . '</th><th class="text-right">' . $this->sma->formatMoney($inv->product_tax+$return_sale->product_tax) . '</th></tr>';
                                echo '</tfoot></table>';
                            }
                        }
                        ?>
