<script>
    $(document).ready(function () {
        ...
        $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getTaxRates') ?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, {"mRender": decimalFormat}, {"mRender": tax_type}, {"bSortable": false}]
        });
    });
</script>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo site_url('system_settings/add_tax_rate'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_tax_rate') ?></a></li>
