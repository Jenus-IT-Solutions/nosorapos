<script>
    $(document).ready(function () {
        $('#CGData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getCustomerGroups') ?>',
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo site_url('system_settings/add_customer_group'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_customer_group') ?></a>
                        </li>
                        ...
                        <li><a href="#" id="delete" data-action="delete"><i
                                    class="fa fa-trash-o"></i> <?= lang('delete_customer_groups') ?></a></li>
