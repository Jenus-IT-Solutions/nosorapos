<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("system_settings/import_subcategories", $attrib)
        ?>
        <div class="modal-body">
            <a href="<?php echo base_url(); ?>assets/csv/sample_subcategories.csv" class="btn btn-primary pull-right">
            ...
            <div class="well well-small">
                ...
                <span class="text-info">
                    (<?= lang("code") . ', ' . lang("name") . ', ' . lang("parent_category_code") . ', ' . lang("image"); ?>)
                </span> <?= lang("csv3"); ?>
            </div>
