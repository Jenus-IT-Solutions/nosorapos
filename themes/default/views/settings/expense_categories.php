            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo site_url('system_settings/add_expense_category'); ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus"></i> <?= lang('add_expense_category') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('system_settings/import_expense_categories'); ?>" data-toggle="modal" data-target="#myModal">
                        ...
                        <li>
                            <a href="#" id="delete" data-action="delete">
                                <i class="fa fa-trash-o"></i> <?= lang('delete_expense_categories') ?>
                            </a>
                        </li>
                    </ul>
                </li>
