    ...
    <div class="well well-sm">
        <div class="row bold">
            ...
            <div class="col-xs-6 pull-right text-right">
                <?php $br = $this->sma->save_barcode($transfer->transfer_no, 'code128', 35, false, $transfer->id); ?>
                <img src="<?= base_url() ?>assets/uploads/barcode<?= $this->session->userdata('user_id').$transfer->id; ?>.png"
                     alt="<?= $transfer->transfer_no ?>"/>
                <?php $this->sma->qrcode('link', urlencode(site_url('transfers/view/' . $transfer->id)), 1, false, $transfer->id); ?>
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            foreach ($rows as $row):
                ...
                <tr>
                    ...
                    <td style="text-align:center; width:80px; "><?php echo $this->sma->formatQuantity($row->quantity).' '.$row->unit; ?></td>
