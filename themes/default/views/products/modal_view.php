                        ...
                        <table class="table table-borderless table-striped dfTable table-right-left">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php if ($Owner || $Admin) {
                                        echo '<tr><td>' . lang("product_cost") . '</td><td>' . $this->sma->formatMoney($product->cost) . '</td></tr>';
                                        echo '<tr><td>' . lang("product_price") . '</td><td>' . $this->sma->formatMoney($product->price) . '</td></tr>';
