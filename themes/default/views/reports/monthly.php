...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-calendar"></i><?= lang('monthly_sales').' ('.($sel_warehouse ? $sel_warehouse->name : lang('all_warehouses')).')'; ?></h2>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped dfTable reports-table">
                        ...
                        <tr class="year_roller">
                            <th><a class="white" href="<?= site_url('reports/monthly_sales/'.($warehouse_id ? $warehouse_id : 0).'/'.($year-1)); ?>">&lt;&lt;</a></th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/monthly_sales/'.($warehouse_id ? $warehouse_id : 0).'/'.$year.'/pdf')?>";
            return false;
        });
